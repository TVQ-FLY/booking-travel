  ...
  <div class="grid-form1">
  	       <h3>CẬP NHẬT DỮ LIỆU TRANG</h3>
  	         ...
  	         <div class="tab-content">
                  ...
                  <option value="" selected="selected" class="form-control">VUI LÒNG CHỌN</option>
                  <option value="manage-pages.php?type=Team">ĐỘI NGŨ VÀ NGƯỜI DÙNG</option>
                  <option value="manage-pages.php?type=Privacy">CHÍNH SÁCH VÀ BẢO MẬT</option>
                  <option value="manage-pages.php?type=About">TỔNG QUAN</option> 
...
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">NỘI DUNG CẬP NHẬT</label>
									<div class="col-sm-8">
