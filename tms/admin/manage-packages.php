...
{				?>	
						<tr>
							...
							<td><a href="delete-package.php?pid=<?php echo htmlentities($result->PackageId);?>"><button type="button" onclick="deleteBook(<?= $packagesID ?>)" class="btn btn-primary btn-block">Delete Details</button></a></td>  
						</tr>
						 <?php $cnt=$cnt+1;} }?>
						</tbody>
					  </table>
