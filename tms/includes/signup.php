...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
				...
				<input type="text" value="" placeholder="Name" name="fname" autocomplete="off" required="">
				<input type="text" value="" placeholder="Phone number" maxlength="10" name="mobilenumber" autocomplete="off" required="">
