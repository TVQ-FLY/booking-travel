...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Thêm Tour</li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
...
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">GIÁ (USD)</label>
									<div class="col-sm-8">
...
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">ĐẶC TRƯNG</label>
									<div class="col-sm-8">
...
<div class="form-group">
			...
			<div class="col-sm-8 col-sm-offset-2">
				...
				<button type="reset" class="btn-inverse btn">NHẬP LẠI</button>
			</div>
		</div>
