...
<div class="container">
	<div class="rupes">
		<div class="col-md-4 rupes-left wow fadeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">
			...
			<div class="rup-rgt">
				<h3>GIẢM 30%</h3>
				<h4><a href="offers.html">TOUR SMART</a></h4>
		...
		<div class="col-md-4 rupes-left wow fadeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">
			...
			<div class="rup-rgt">
				<h3>GIẢM 50%</h3>
				<h4><a href="offers.html">VỚI KHÁCH SẠN TRÊN THẾ GIỚI</a></h4>
		...
		<div class="col-md-4 rupes-left wow fadeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">
			...
			<div class="rup-rgt">
				<h3>GIẢM 20%</h3>
				<h4><a href="offers.html">KHI ĐẶT TOUR QUA APP</a></h4>
...
<div id="about" class="about">
         <div class="container">
            <div class="row">
               <div class="col-md-12 ">
                  <div class="titlepage">
                     <h2>TỔNG QUAN VỀ BOOKING TRAVEL</h2>
...
<div id="travel" class="traveling">
         <div class="container">
            <div class="row">
               <div class="col-md-12 ">
                  <div class="titlepage">
                     <h2>CÁC ƯU ĐÃI TRONG QUÁ TRÌNH DU LỊCH</h2>
      ...
      <div id="blog" class="blog">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <div class="titlepage">
                     <h2>MỘT VÀI ĐỊA ĐIỂM NỔI BẬT</h2>
            ...
            <div class="row">
               <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                  <div class="blog-box">
                     ...
                     <div class="travel">
                        ...
                        <p><strong class="Comment"> 2314 </strong>  Bình Luận</p>
                        <p><strong class="like">5231 </strong>Lượt Thích</p>
                     </div>
                     <h3>Nhà Trắng</h3>
               ...
               <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                  <div class="blog-box">
                     ...
                     <div class="travel">
                        <span>Đăng bởi: Trần Quyền</span> 
                        <p><strong class="Comment"> 4256 </strong>  Bình Luận</p>
                        <p><strong class="like">12624 </strong>Lượt Thích</p>
                     </div>
                     <h3>Điện Kremli</h3>
...
{	?>
			<div class="rom-btm">
				...
				<div class="col-md-3 room-right wow fadeInRight animated" data-wow-delay=".5s">
					<h5><?php echo htmlentities($result->PackagePrice);?> USD</h5>
