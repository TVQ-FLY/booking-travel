...
<div class="selectroom">
	<div class="container">	
		  <?php if($error){?><div class="errorWrap"><strong>THẤT BẠI</strong>:<?php echo htmlentities($error); ?> </div><?php } 
				else if($msg){?><div class="succWrap"><strong>THÀNH CÔNG !</br></strong><?php echo htmlentities($msg); ?> </div><?php }?>
<?php 
$pid=intval($_GET['pkgid']);
...
<form name="book" method="post">
		<div class="selectroom_top">
			...
			<div class="bnr-right">
				<label class="inputLabel">Đến ngày</label>
		...
		<h3>Chi Tiết</h3>
				<p style="padding-top: 1%"><?php echo "<pre>".htmlentities($result->PackageDetails)."</pre>";?> </p>	
				<div class="clearfix"></div>
		</div>
		<div class="selectroom_top">
